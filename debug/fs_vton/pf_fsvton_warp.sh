...
./scripts/viton/viton.sh --job_name $VITON_NAME --task $TASK --experiment_number $EXPERIMENT_NUMBER --run_number $RUN_NUMBER \
    ...
    --parser_based_warp_experiment_from_number 30 --parser_based_warp_run_from_number 29 --warp_load_from_model Rail \
    --parser_based_gen_experiment_from_number 32 --parser_based_gen_run_from_number 30 --gen_load_from_model Rail \
